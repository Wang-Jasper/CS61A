...
def merge(incr_a, incr_b):
    ...
    while next_a is not None or next_b is not None:
        ...
        elif next_a is None or next_b is not None and next_b < next_a:
            yield next_b
            next_b = next(iter_b, None)
        else:  # same case, because the list initially are ordered, so same elem will eventually come across
            yield next_a
            next_a, next_b = next(iter_a, None), next(iter_b, None)
