...
def balanced(m):
    ...
    """
    "*** YOUR CODE HERE ***"
    # The torque applied by its left arm is equal to the torque applied by its right arm
    if not is_mobile(m):
        return True
...
def make_anonymous_factorial():
    ...
    True
    """
    return (lambda f: lambda k: f(f, k))(lambda f, k: 1 if k == 1 else mul(k, f(f, k - 1)))
