...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
        return False
    elif math.gcd(player_score, opponent_score) >= 10:
        return True
    else:
        return False
    # END PROBLEM 4a
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            if strategy0 == 0:
                ...
                tmp = strategy0(score0, score1)
                score0 += take_turn(tmp, score1, dice)
            ...
            if strategy1 == 0:
                ...
                tmp = strategy1(score1, score0)
                score1 += take_turn(tmp, score0, dice)
...
def final_strategy(score, opponent_score, cutoff=4, goal=GOAL_SCORE, num_rolls=6):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # BEGIN PROBLEM 12
    # return 6  # Replace this statement
    cutoff = min(goal - score, opponent_score - score)
    if free_bacon(opponent_score) >= cutoff:
        return 0
    else:
        return num_rolls
        # num_rolls = extra_turn_strategy(score, opponent_score, make_averaged(roll_dice)(max_scoring_num_rolls(six_sided))
    # END PROBLEM 12
